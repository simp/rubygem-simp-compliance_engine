...
RSpec.describe 'lookup' do
  ...
  on_supported_os.each do |os, os_facts|
    context "on #{os} with compliance_engine::::enforcement and an existing profile using tolerance above level 21" do
      let(:facts) do
        os_facts.merge('custom_hiera' => 'compliance_engine', 'target_compliance_profile' => '01_profile_test', 'target_enforcement_tolerance' => '22', 'custom_hiera' => 'compliance_engine')
      end
    ...
    context "on #{os} with compliance_engine::::enforcement and an existing profile using tolerance above level 41" do
      let(:facts) do
        os_facts.merge('custom_hiera' => 'compliance_engine', 'target_compliance_profile' => '01_profile_test', 'target_enforcement_tolerance' => '42')
      end
      let(:hieradata) { 'compliance_engine' }
    ...
    context "on #{os} with compliance_engine::::enforcement and an existing profile using tolerance above level 61" do
      let(:facts) do
        os_facts.merge('custom_hiera' => 'compliance_engine', 'target_compliance_profile' => '01_profile_test', 'target_enforcement_tolerance' => '62')
      end
      let(:hieradata) { 'compliance_engine' }
    ...
    context "on #{os} with compliance_engine::::enforcement and an existing profile using tolerance above level 81" do
      let(:facts) do
        os_facts.merge('custom_hiera' => 'compliance_engine', 'target_compliance_profile' => '01_profile_test', 'target_enforcement_tolerance' => '82')
      end
      let(:hieradata) { 'compliance_engine' }
